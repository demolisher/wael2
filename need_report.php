...
$chosen_level = $sl_need['level'];
$select_class = mysqli_query($conn, "SELECT * FROM `classes` WHERE level = '$chosen_level'") or die('فشل الاستعلام من بيانات الخادم');
  ...
  <div class="container" style="max-width: 86%;">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php require_once('includes/components/report_forms.php'); ?>
      </div>
      <?php require_once('includes/components/footer.php'); ?>
    </div>
  </div>
  <?php require_once('includes/components/r_scripts.php'); ?>
</body>
